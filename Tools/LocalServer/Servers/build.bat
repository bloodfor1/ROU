...
msbuild ..\..\..\..\roserver\winproject\controlserver\controlserver.vcxproj /t:build /p:Configuration=Debug;Platform=x64
if %errorlevel%==1 (
	color c
...
msbuild ..\..\..\..\roserver\winproject\dbserver\dbserver.vcxproj /t:build /p:Configuration=Debug;Platform=x64
if %errorlevel%==1 (
	color c
	echo "[CUSTOM]compile dbserver failed"
	goto error
)
echo "compile dbserver success"

echo "[CUSTOM]begin compile gameserver"
msbuild ..\..\..\..\roserver\winproject\gameserver\gameserver.vcxproj /t:build /p:Configuration=Debug;Platform=x64
if %errorlevel%==1 (
	color c
...
msbuild ..\..\..\..\roserver\winproject\gateserver\gateserver.vcxproj /t:build /p:Configuration=Debug;Platform=x64
if %errorlevel%==1 (
	color c
...
::msbuild ..\..\..\..\roserver\winproject\loginserver\loginserver.vcxproj /t:build /p:Configuration=Debug;Platform=x64
::if %errorlevel%==1 (
::  color c
...
msbuild ..\..\..\..\roserver\winproject\masterserver\masterserver.vcxproj /t:build /p:Configuration=Debug;Platform=x64
if %errorlevel%==1 (
	color c
...
msbuild ..\..\..\..\roserver\winproject\tradeserver\tradeserver.vcxproj /t:build /p:Configuration=Debug;Platform=x64
if %errorlevel%==1 (
	color c
...
rem msbuild ..\..\..\..\roserver\winproject\proxyserver\proxyserver.vcxproj /t:build /p:Configuration=Debug;Platform=x64
rem if %errorlevel%==1 (
rem 	color c
...
msbuild ..\..\..\..\roserver\winproject\battleserver\battleserver.vcxproj /t:build /p:Configuration=Debug;Platform=x64
if %errorlevel%==1 (
	color c
...
msbuild ..\..\..\..\roserver\winproject\audioserver\audioserver.vcxproj /t:build /p:Configuration=Debug;Platform=x64
if %errorlevel%==1 (
	color c
...
echo "[CUSTOM]begin compile payserver"
msbuild ..\..\..\..\roserver\winproject\payserver\payserver.vcxproj /t:build /p:Configuration=Debug;Platform=x64
if %errorlevel%==1 (
	color c
	echo "[CUSTOM]compile payserver failed"
	goto error
)
echo "[CUSTOM]compile payserver success"
