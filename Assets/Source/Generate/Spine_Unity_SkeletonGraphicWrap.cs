...
public class Spine_Unity_SkeletonGraphicWrap
{
	...
	{
		ToLua.Push(L, new EventObject("Spine.Unity.SkeletonGraphic.UpdateLocal"));
		return 1;
	}
	...
	{
		ToLua.Push(L, new EventObject("Spine.Unity.SkeletonGraphic.UpdateWorld"));
		return 1;
	}
	...
	{
		ToLua.Push(L, new EventObject("Spine.Unity.SkeletonGraphic.UpdateComplete"));
		return 1;
	}
	...
	{
		ToLua.Push(L, new EventObject("Spine.Unity.SkeletonGraphic.OnPostProcessVertices"));
		return 1;
	}
	...
	static int set_UpdateLocal(IntPtr L)
	{
		try
		{
			...
			{
				Spine.Unity.UpdateBonesDelegate ev = (Spine.Unity.UpdateBonesDelegate)DelegateTraits<Spine.Unity.UpdateBonesDelegate>.Create(arg0.func);
				obj.UpdateLocal += ev;
			}
			else if (arg0.op == EventOp.Sub)
			{
				Spine.Unity.UpdateBonesDelegate ev = (Spine.Unity.UpdateBonesDelegate)LuaMisc.GetEventHandler(obj, typeof(Spine.Unity.SkeletonGraphic), "UpdateLocal");
	...
	static int set_UpdateWorld(IntPtr L)
	{
		try
		{
			...
			{
				Spine.Unity.UpdateBonesDelegate ev = (Spine.Unity.UpdateBonesDelegate)LuaMisc.GetEventHandler(obj, typeof(Spine.Unity.SkeletonGraphic), "UpdateWorld");
				Delegate[] ds = ev.GetInvocationList();
				LuaState state = LuaState.Get(L);
	...
	static int set_UpdateComplete(IntPtr L)
	{
		try
		{
			...
			{
				Spine.Unity.UpdateBonesDelegate ev = (Spine.Unity.UpdateBonesDelegate)LuaMisc.GetEventHandler(obj, typeof(Spine.Unity.SkeletonGraphic), "UpdateComplete");
				Delegate[] ds = ev.GetInvocationList();
				LuaState state = LuaState.Get(L);
	...
	static int set_OnPostProcessVertices(IntPtr L)
	{
		try
		{
			...
			{
				Spine.Unity.MeshGeneratorDelegate ev = (Spine.Unity.MeshGeneratorDelegate)LuaMisc.GetEventHandler(obj, typeof(Spine.Unity.SkeletonGraphic), "OnPostProcessVertices");
				Delegate[] ds = ev.GetInvocationList();
				LuaState state = LuaState.Get(L);
