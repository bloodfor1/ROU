...
public:
    ...
    virtual void _OnLocationGotCountryFromIPNotify(WGBaseObserver *observer, ConvertGetCountryFromIPRet&fromIPRet) = 0;
...
public:
    ...
    virtual void OnLocationGotCountryFromIPNotify(GetCountryFromIPRet& fromIPRet) {}
