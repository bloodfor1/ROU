...
--lua functions
---@class EquipEnchantPanel.NewAttrPrefab
---@field PanelRef MoonClient.MLuaUIPanel
---@field Text MoonClient.MLuaUICom
---@field Image MoonClient.MLuaUICom

---@class EquipEnchantPanel
---@field PanelRef MoonClient.MLuaUIPanel
...
---@field NewAttrPrefab EquipEnchantPanel.NewAttrPrefab

---@return EquipEnchantPanel
---@param ctrl UIBase
function EquipEnchantPanel.Bind(ctrl)
