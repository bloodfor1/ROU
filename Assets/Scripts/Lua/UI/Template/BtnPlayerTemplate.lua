...
--lua class define
---@class BtnPlayerTemplateParameter
...
---@class BtnPlayerTemplate : BaseUITemplate
---@field Parameter BtnPlayerTemplateParameter

BtnPlayerTemplate = class("BtnPlayerTemplate", super)
--lua class define end

--lua functions
function BtnPlayerTemplate:Init()
    super.Init(self)
    self.coMgr = MgrMgr:GetMgr("CoroutineMgr")
end --func end
--next--
function BtnPlayerTemplate:OnDestroy()
    self.head2d = nil
    if self.co then
        self.coMgr:removeCo(self.co)
        self.co = nil
    end
end --func end
--next--
function BtnPlayerTemplate:OnSetData(data)
    ...
    self.Parameter.MVP.UObj:SetActiveEx(data.isMvp or false)
    ...
    self.co = self.coMgr:addCo(function()
        AwaitTime((self.ShowIndex - 1) * 0.3)
        self.Parameter.BtnPlayer:PlayFx()
    end)
end --func end
--next--
function BtnPlayerTemplate:OnDeActive()


end --func end
--next--
function BtnPlayerTemplate:BindEvents()
...
--lua custom scripts
function BtnPlayerTemplate:SetHead()

end
--lua custom scripts end
return BtnPlayerTemplate