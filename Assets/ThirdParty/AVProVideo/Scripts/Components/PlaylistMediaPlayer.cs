...
namespace RenderHeads.Media.AVProVideo
{
	...
	public class MediaPlaylist
	{
		...
		public class MediaItem
		{
			...
			[SerializeField]
			public MoonCommonLib.EFileLocation fileLocation = MoonCommonLib.EFileLocation.RelativeToStreamingAssetsFolder;
	...
	public class PlaylistMediaPlayer : MediaPlayer, IMediaProducer
	{
		...
		private void SwapPlayers()
		{
			...
			Events.Invoke(this, MoonCommonLib.EEventType.PlaylistItemChanged, MoonCommonLib.EErrorCode.None);
		...
		public void OnVideoEvent(MediaPlayer mp, MoonCommonLib.EEventType et, MoonCommonLib.EErrorCode errorCode)
		{
			if (mp == CurrentPlayer)
			{
		...
		public bool NextItem()
		{
			...
			if (!result)
			{
				Events.Invoke(this, MoonCommonLib.EEventType.PlaylistFinished, MoonCommonLib.EErrorCode.None);
			}
			return result;
		}
