...
{
	[System.Serializable]
	public class MediaPlayerEvent : UnityEngine.Events.UnityEvent<MediaPlayer, MoonCommonLib.EEventType, MoonCommonLib.EErrorCode>
	{
		private List<UnityEngine.Events.UnityAction<MediaPlayer, MoonCommonLib.EEventType, MoonCommonLib.EErrorCode>> _listeners = new List<UnityEngine.Events.UnityAction<MediaPlayer, MoonCommonLib.EEventType, MoonCommonLib.EErrorCode>>(4);
		...
		new public void AddListener(UnityEngine.Events.UnityAction<MediaPlayer, MoonCommonLib.EEventType, MoonCommonLib.EErrorCode> call)
		{
		...
		new public void RemoveListener(UnityEngine.Events.UnityAction<MediaPlayer, MoonCommonLib.EEventType, MoonCommonLib.EErrorCode> call)
		{
	...
	public interface IMediaControl
	{
        ...
        MoonCommonLib.EErrorCode GetLastError();
	...
	public static class Helper
	{
		...
		public static string GetErrorMessage(MoonCommonLib.EErrorCode code)
		{
			string result = string.Empty;
			switch (code)
			{
				case MoonCommonLib.EErrorCode.None:
					result = "No Error";
					break;
				case MoonCommonLib.EErrorCode.LoadFailed:
...
#endif
					break;
				case MoonCommonLib.EErrorCode.DecodeFailed:
