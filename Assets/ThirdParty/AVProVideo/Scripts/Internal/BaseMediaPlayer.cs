...
namespace RenderHeads.Media.AVProVideo
{
	...
	public abstract class BaseMediaPlayer : IMediaPlayer, IMediaControl, IMediaInfo, IMediaProducer, IMediaSubtitles, System.IDisposable
	{
		...
		public virtual void			CloseVideo()
		{
			...
			_lastError = MoonCommonLib.EErrorCode.None;
		}
		...
		public MoonCommonLib.EErrorCode GetLastError()
		{
			return _lastError;
		}
		...
		protected MoonCommonLib.EErrorCode _lastError = MoonCommonLib.EErrorCode.None;
